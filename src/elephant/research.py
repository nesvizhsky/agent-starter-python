...
_guidance_research_prompt = (
    ...
    "if the topic is geographically specific; if — and only if — the topic has CONCRETE, "
    "NAMED adversarial parties (specific states, a specific government vs. a specific named "
    "opposition, a specific regulator vs. a specific named industry coalition), each named "
    "party's own state/party-aligned press, named symmetrically for every party (a spectrum "
    "of editorial opinions about a broad topic is NOT the same as named adversarial parties "
    "— skip this category entirely if there isn't a real, specific dispute); general-interest "
    "wire services and international/national press as a neutral layer; and "
    "academic/institutional primary sources where relevant (arXiv, PubMed, IAEA, WHO). "
    "Name specific outlets."
)
...
_sides_research_prompt = (
    ...
    "country? The dispute must be the topic's main subject, not a tangential angle. "
