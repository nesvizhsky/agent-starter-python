...
async def research(
    ...
    *,
    ...
    search_after_date: "MM/DD/YYYY" — Perplexity's date-based filter.
    search_recency_filter: "day" | "week" | "month" — simpler recency filter;
      more reliably forwarded by OpenRouter than search_after_date_filter.
    """
